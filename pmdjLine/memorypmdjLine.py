...
for i in range(5):
    try:
        p = ProcessAnalyzer(["$HOME/pmd-bin-5.8.1/bin/run.sh pmd -d jline3.zip -f text -R java-basic,java-imports,java-unusedcode"])
        p.execute()
...
print 'avg_max_rss_memory:', (average / 5) / ((1024.0 ** 2))
